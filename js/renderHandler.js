...
const renderZBuffer = (zBuffer, imageData) => {
  for (let i = 0; i < zBuffer.width; i += 1) {
...
/**
 * Renders black outline for each face
 *
 * @param {Face} face
 * @param {ImageData} imageData
 * @param {Uint8ClampedArray} zBuffer
 * @param {Number[]} color Color presented as [R, G, B, A]
 * @param {Boolean} overrideZBuffer
 */
 ...
 * @param {Boolean} perspective Whether or not to add perspective
